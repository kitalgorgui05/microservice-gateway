...
import {AnneeService} from "../../Inscriptiondb/annee/annee.service";
import {IAnnee} from "../../../shared/model/Inscriptiondb/annee.model";
...
export class TrimestreComponent implements OnInit, OnDestroy {
  ...
  getAllAnnee(): any{
      return this.anneeService.query().subscribe(
        {
          next:(data)=>{
  ...
  delete(trimestre: ITrimestre): void {
    const modalRef = this.modalService.open(TrimestreDeleteDialogComponent, { size: 'sm', backdrop: 'static' });
