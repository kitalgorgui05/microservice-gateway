...
export class ReglementComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.reglementService
      ...
      .subscribe(
        (res: HttpResponse<IReglement[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IReglement[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
