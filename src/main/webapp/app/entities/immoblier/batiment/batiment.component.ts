...
export class BatimentComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
   ...
   /* protected recherche(someValue?:any): any{
     this.batimentService.query({'nom.containe':someValue}).subscribe();
  } */
  ...
  delete(batiment: IBatiment): void {
    const modalRef = this.modalService.open(BatimentDeleteDialogComponent, { size: 'sm', backdrop: 'static' });
